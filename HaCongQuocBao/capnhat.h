void input(char s[40]) {
    ...
    while(1) {
        ...
        if(n == 27) {
            ...
            DrawLine(27, 6, "Moi ban tiep tuc su dung chuong trinh!", 14);
            return;
        }
...
// ghi là all để phát triển thêm tính năng sẽ dùng chuanhoaAll(char[20]) để chuẩn hóa
...
// xử lý dữ liệu và in ra theo các trang
int numberPage=1;

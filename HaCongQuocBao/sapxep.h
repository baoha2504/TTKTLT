...
{
	char s1[40], s2[40];
	strcpy(s1, a.MaLop); // sao chép 2 chuỗi
	strcpy(s2, b.MaLop);
	if (strcmp(s1, s2) > 0) return 1; // so sánh chiều dài 2 chuỗi trả về 3 giá tri ==, >, < 0
...
// Nhap du lieu vao file de tim kiem nhi phan Binary Tree
//Nhap MA LOP vao file nhi phan
...
//Nhap vao file nhi phan MA SINH VIEN
...
//Nhap vao file nhi phan NGAY SINH
...
//Nhap vao file nhi phan DIEM TRUNG BINH
...
//Nhap vao file nhi phan GHI CHU
